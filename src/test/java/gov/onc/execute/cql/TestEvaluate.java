...
import org.hl7.fhir.r4b.utils.GraphQLSchemaGenerator;
...
//import org.opencds.cqf.cql.evaluator.cli.command.CqlCommand.NamespaceParameter;
//import org.opencds.cqf.cql.evaluator.cli.command.RunCQL.LibraryParameter.ContextParameter;
//import org.opencds.cqf.cql.evaluator.cli.command.RunCQL.LibraryParameter.ModelParameter;
...
public class TestEvaluate {
	...
	GraphQLSchemaGenerator jjjj;
	
	GraphQLSchemaGenerator asdfss;
	
	GraphQLProviderWithIntrospection asdf;
	
	GraphQLProvider foobar;
	...
	public static void main(String[] args) {
	 ...
	 BaseAdvisor ba;
		...
		FhirVersionEnum fhirVersionEnum = FhirVersionEnum.valueOf(fhirVersion);
	        ...
	        gov.onc.execute.cql.TestEvaluate.LibraryParameter.ContextParameter context = new gov.onc.execute.cql.TestEvaluate.LibraryParameter.ContextParameter();;
	        context.contextName = "Patient";
	        context.contextValue="example";		
			lp.context = context;
			gov.onc.execute.cql.TestEvaluate.LibraryParameter.ModelParameter model = new gov.onc.execute.cql.TestEvaluate.LibraryParameter.ModelParameter();
