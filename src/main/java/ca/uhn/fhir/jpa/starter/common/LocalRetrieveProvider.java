...
public class LocalRetrieveProvider extends TerminologyAwareRetrieveProvider {

	private static final Logger logger = LoggerFactory.getLogger(LocalRetrieveProvider.class);
	...
	public LocalRetrieveProvider(final FhirContext fhirContext, final IBaseBundle iBaseBundle) {
